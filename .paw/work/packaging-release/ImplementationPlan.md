...
- **I1 (dev-deploy fast path — Opus)**: `isInstalled` adopts trust-and-record fallback when the marker is missing; `scripts/deploy.mjs` writes the marker on copy. The "no overhaul" exclusion is narrowed to permit this additive edit.
