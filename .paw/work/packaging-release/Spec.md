...
- FR-007: The preflight skill verifies: (a) clean working tree, (b) on the release branch (`main`), (c) the release branch is up to date with its remote, (d) the typecheck and test suites pass, (e) target version is strictly greater than the currently-released version. Any failure halts the release. (Stories: P1)
